...
export default function  AddCartBtn  () {
  return (
    <button aria-label="add to cart button" 
      className={`group/btn uppercase relative flex justify-center items-center  bg-transparent border border-black text-heading w-full tracking-wide text-sm px-6 py-2  cursor-pointer selection:bg-transparent overflow-hidden mx-auto`} onClick={()=>alert("it's an alert")}
    >
