...
export const ProductDetailsSection = () => {
  return ( <main className="bg-body min-h-screen py-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-start">
          ...
          <section className="flex flex-col py-4 lg:py-8">
            ...
            <nav className="font-inter text-[10px] tracking-[0.15em] uppercase mb-8">
              ...
              <span className="text-muted-text mx-2">/</span>
              <span className="text-heading font-semibold">Mithila Keychain</span>
            </nav>
            ...
            {/* Call to Action */}
            <button className="w-full bg-primary hover:bg-primary-hover text-white font-inter text-[px font-bold tracking-[0.2em] uppercase py-5 transition-colors flex items-center justify-center gap-3">
              Add to Cart 
            ...
            <div className="flex items-center justify-center mb-12">
              ...
              <svg className="w-5 h-5 mx-4 text-muted-text" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
