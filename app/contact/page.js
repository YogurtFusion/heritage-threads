  ...
  return (
    ...
    <main className="bg-[var(--color-body)] min-h-screen py-16 px-6 md:px-12 lg:px-24">
      ...
      <section className="max-w-6xl mx-auto mb-16">
        ...
        <h1 className="font-playfair text-[var(--color-heading)] text-5xl md:text-6xl font-bold uppercase mb-6">
          Contact Us
        </h1>
        {/* Inter body text, slightly muted for readability */}
        <p className="font-inter text-[var(--color-body-text)] max-w-2xl text-lg leading-relaxed">
      ...
      <section className="max-w-6xl mx-auto flex flex-col lg:flex-row border border-[var(--color-border)]">
        
        {/* Left Column - Contact Form */}
        {/* Uses the card background variable, relative positioning for the background graphic */}
        <div className="w-full lg:w-1/2 bg-[var(--color-card)] p-8 md:p-16 relative overflow-hidden">
          
          <form className="relative z-10">
            {/* Full Name Field */}
            <div className="mb-8">
              <label className="block font-inter text-xs font-bold tracking-widest text-[var(--color-heading)] uppercase mb-2">
                Full Name
              </label>
              ...
              <input 
                ...
                className="w-full bg-transparent border-b border-[var(--color-heading)] py-2 font-inter text-[var(--color-body-text)] placeholder-[var(--color-muted-text)] focus:outline-none"
              />
            </div>
            ...
            <div className="mb-8 relative">
              ...
              <select className="w-full bg-transparent border-b border-[var(--color-heading)] py-2 font-inter text-[var(--color-body-text)] appearance-none focus:outline-none">
                <option>General Inquiry</option>
                <option>Bespoke Commission</option>
                <option>Artisan Application</option>
              </select>
              {/* Custom dropdown arrow */}
              <div className="absolute right-0 bottom-3 pointer-events-none text-[var(--color-heading)]">
            ...
            <div className="mb-12">
              ...
              <textarea 
                ...
                rows="4"
                className="w-full bg-transparent border-b border-[var(--color-heading)] py-2 font-inter text-[var(--color-body-text)] placeholder-[var(--color-muted-text)] focus:outline-none resize-none"
              ></textarea>
            </div>
            ...
            <button 
              type="button"
              className="bg-[var(--color-primary)] hover:bg-[var(--color-primary-hover)] text-white font-inter text-sm font-semibold tracking-widest uppercase py-4 px-8 transition-colors"
            >
              Send Message
            </button>
          </form>
          ...
          <div className="absolute -bottom-16 -right-16 text-[var(--color-border)] opacity-40 pointer-events-none">
        ...
        <div className="w-full lg:w-1/2 bg-[var(--color-body)] p-8 md:p-16 flex flex-col justify-center">
          
          {/* Direct Lines Section */}
          <div className="mb-12">
            <h2 className="font-playfair text-[var(--color-heading)] text-2xl mb-8 font-semibold">
              Direct Lines
            </h2>
            <ul className="space-y-6">
              {/* Email */}
              <li className="flex items-start gap-4 text-[var(--color-body-text)] font-inter">
          ...
          <div>
            <h2 className="font-playfair text-[var(--color-heading)] text-2xl mb-4 font-semibold">
              Immediate Assistance
            </h2>
            <p className="font-inter text-[var(--color-body-text)] mb-6 text-sm leading-relaxed">
              For urgent bespoke updates or direct artisan consultation, reach us on WhatsApp.
            </p>
            {/* Outline Button */}
            <button 
              type="button"
              className="w-full flex items-center justify-center gap-3 border border-[var(--color-secondary)] text-[var(--color-secondary)] hover:bg-[var(--color-secondary)] hover:text-white transition-colors py-4 px-6 font-inter text-sm font-semibold tracking-widest uppercase"
            >
