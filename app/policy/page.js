...
export default function PoliciesPage() {
  return (
    <main className="bg-body min-h-screen pt-16 pb-24 px-6 md:px-12 lg:px-24">
      {/* Page Header */}
        ...
        <div className="flex-1 max-w-3xl">
          ...
          <section id="returns" className="mb-20">
            ...
            <div className="bg-[#F6EBE8] p-8 border border-section/30">
              ...
              <button 
                type="button" 
                className="bg-primary hover:bg-primary-hover text-white font-inter text-xs font-bold tracking-widest uppercase py-3 px-6 transition-colors"
              >
                Contact Concierge
              </button>
            </div>
